...
class VNA_Exception_Wrong_State(VNA_Exception):
	pass
class VNA_Exception_Missing_Attenuator_Setting(VNA_Exception):
	pass
class VNA_Exception_No_Attenuator_Present(VNA_Exception):
	pass
class VNA_Exception_Bad_Port(VNA_Exception):
	pass
