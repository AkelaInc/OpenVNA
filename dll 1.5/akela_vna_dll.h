...
extern "C" {
	 ...
	 */
	typedef int ErrCode;
	extern VNADLL_API int ERR_OK;
	extern VNADLL_API int ERR_BAD_ATTEN;
	extern VNADLL_API int ERR_BAD_CAL;
	extern VNADLL_API int ERR_BAD_HANDLE;
	extern VNADLL_API int ERR_BAD_HOP;
	extern VNADLL_API int ERR_BAD_PATH;
	extern VNADLL_API int ERR_BAD_PROM;
	extern VNADLL_API int ERR_BYTES;
	extern VNADLL_API int ERR_FREQ_OUT_OF_BOUNDS;
	extern VNADLL_API int ERR_INTERRUPTED;
	extern VNADLL_API int ERR_NO_RESPONSE;
	extern VNADLL_API int ERR_MISSING_IP;
	extern VNADLL_API int ERR_MISSING_PORT;
	extern VNADLL_API int ERR_MISSING_HOP;
	extern VNADLL_API int ERR_MISSING_ATTEN;
	extern VNADLL_API int ERR_MISSING_FREQS;
	extern VNADLL_API int ERR_PROG_OVERFLOW;
	extern VNADLL_API int ERR_SOCKET;
	extern VNADLL_API int ERR_TOO_MANY_POINTS;
	extern VNADLL_API int ERR_WRONG_STATE;
	extern VNADLL_API int ERR_EMPTY_PROM;
	extern VNADLL_API int ERR_PATH_ALREADY_MEASURED;
	extern VNADLL_API int ERR_NO_PATHS_MEASURED;
	extern VNADLL_API int ERR_NO_ATTEN_PRESENT;
	extern VNADLL_API int ERR_PROG_TYPE;
